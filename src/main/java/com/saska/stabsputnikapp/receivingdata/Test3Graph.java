...
public class Test3Graph extends Application {
    ...
    public void shiftSeriesData(float newValue)
    {
        ...
        XYChart.Data<String, Number> lastData = (XYChart.Data<String, Number>)series.getData().get(NUM_OF_POINT-1);
            ...
            serialPort.addEventListener((SerialPortEvent serialPortEvent) -> {
                if(serialPortEvent.isRXCHAR()){
                    try {
                        ...
                        Logger.getLogger(Test3Graph.class.getName())
